<!-- Modal -->
<div wire:ignore.self class="modal fade" id="createInventoryItem" tabindex="-1" aria-labelledby="createInventoryItemLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="createInventoryItemLabel">Create Inventory Item</h1>
